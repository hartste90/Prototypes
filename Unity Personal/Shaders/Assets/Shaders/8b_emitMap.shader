	...
	SubShader 
	{
		Pass
		{
			...
			float4 frag(vertexOutput i) : COLOR
			{
				...
				float3 lightFinal = rimLighting + diffuseReflection + ( specularReflection * tex.a) + (texE.xyz * _EmitStrength) + UNITY_LIGHTMODEL_AMBIENT.xyz;
