  ...
  module.exports = function(grunt) {
    ...
    options = {
      ...
      coffee: {
        compile: {
          files: {
            "tmp/output_coffee.js": ["src/coffee/module.coffee", "src/coffee/extensions/*.coffee", "src/coffee/directives/api/utils/*.coffee", "src/coffee/directives/api/managers/*.coffee", "src/coffee/controllers/polyline-display.js", "src/coffee/utils/LatLngArraySync.coffee", "src/coffee/utils/MapEvents.coffee", "src/coffee/directives/api/models/child/*.coffee", "src/coffee/directives/api/models/parent/*.coffee", "src/coffee/directives/api/*.coffee", "src/coffee/directives/map.coffee", "src/coffee/directives/marker.coffee", "src/coffee/directives/markers.coffee", "src/coffee/directives/label.coffee", "src/coffee/directives/polygon.coffee", "src/coffee/directives/circle.coffee", "src/coffee/directives/polyline*.coffee", "src/coffee/directives/rectangle.coffee", "src/coffee/directives/window.coffee", "src/coffee/directives/windows.coffee", "src/coffee/directives/layer.coffee"],
      ...
      concat: {
        ...
        dist: {
          src: ["tmp/output_coffee.js", "src/js/**/*.js", "src/js/**/**/*.js", "src/js/**/**/**/*.js", "lib/*.js"],
          dest: "tmp/output.js"
        }
      },
      copy: {
      ...
      jshint: {
        all: ["Gruntfile.js", "temp/spec/js/*.js", "temp/spec/js/**/*.js", "temp/spec/js/**/**/*.js", "src/js/**/*.js", "src/js/**/**/*.js", "src/js/**/**/**/*.js"]
      },
      test: {},
      watch: {
        all: {
          ...
          files: ["src/coffee/*.coffee", "src/coffee/**/*.coffee", "src/coffee/**/**/*.coffee", "src/js/*.js", "src/js/**/*.js", "src/js/**/**/*.js"],
          tasks: ["clean:dist", "jshint", "mkdir", "coffee", "concat:dist", "copy:dist", "uglify", "jasmine:spec", "clean:example", "coffee"]
        },
        spec: {
          options: {
            livereload: true
    ...
    grunt.registerTask("default", ["clean:dist", "jshint", "mkdir", "coffee", "concat:dist", "copy:dist", "uglify", "jasmine:spec"]);
    grunt.registerTask("spec", ["clean:dist", "jshint", "mkdir", "coffee", "concat:dist", "copy:dist", "connect:jasmineServer", "uglify", "open:jasmine", "watch:spec"]);
    grunt.registerTask("coverage", ["clean:dist", "jshint", "mkdir", "coffee", "concat:dist", "copy:dist", "uglify", "jasmine:coverage"]);
    ...
    return grunt.registerTask("hugedata", ["clean:example", "connect:server", "open:hugedata", "watch:all"]);
  };
